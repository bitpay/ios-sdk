...
- (void)testgetPublicKeyFromPem {
    ...
    NSString *actual = [BPKeyUtils getPublicKeyFromPem: pem];
...
- (void)testgetPrviateKeyFromPem {
    ...
    NSString *actual = [BPKeyUtils getPrivateKeyFromPem: pem];
    XCTAssertEqualObjects(expected, actual);
}
...
- (void)testgenerateSinFromPem {
    ...
    NSString *actual = [BPKeyUtils generateSinFromPem: pem];
    XCTAssertEqualObjects(expected, actual);
}
