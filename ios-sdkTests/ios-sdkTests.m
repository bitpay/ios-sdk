...
@interface IosSDKTests : XCTestCase
@end

@implementation IosSDKTests

- (void)testGeneratePem {
    NSString *pem = [IosSDK generatePem];
...
- (void)testgetPublicKeyFromPem {
    ...
    NSString *actual = [IosSDK getPublicKeyFromPem: pem];
...
- (void)testgetPrviateKeyFromPem {
    ...
    NSString *actual = [IosSDK getPrivateKeyFromPem: pem];
    XCTAssertEqualObjects(expected, actual);
}
...
- (void)testgenerateSinFromPem {
    ...
    NSString *actual = [IosSDK generateSinFromPem: pem];
    XCTAssertEqualObjects(expected, actual);
}
...
- (void)testSignMessageWithPem {
    ...
    NSString *signedMessage = [IosSDK sign: message withPem: pem];
